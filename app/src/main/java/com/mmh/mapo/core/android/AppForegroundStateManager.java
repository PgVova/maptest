...
/**
 * Created by vladimir on 23.07.16.
 */
    ...
    private void validateThenNotifyListeners() {
        ...
        if (mHandler.hasMessages(MESSAGE_NOTIFY_LISTENERS)) {
            ...
            if (mAppForegroundState == AppForegroundState.IN_FOREGROUND) {
                ...
                // We need to validateLogin that the app entered the background. A delay is used to allow for time when the application went into the
